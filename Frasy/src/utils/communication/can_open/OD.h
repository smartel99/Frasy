...
********************************************************************************
    ...
    File info:
        ...
        Project File: frasy.xdd
        File Version: 1

        Created:      2024-04-22 5:28:32 PM
        Created By:   Samuel Martel
        Modified:     2024-04-22 5:59:22 PM
        Modified By:  Samuel Martel

    Device Info:
        Vendor Name:  Samuel Martel
        Vendor ID:    69
        Product Name: Frasy
        Product ID:   1

        Description:  Object Dictionary for Frasy.
*******************************************************************************/

#ifndef FRASY_UTILS_COMMUNICATION_CAN_OPEN_OD_H
#define FRASY_UTILS_COMMUNICATION_CAN_OPEN_OD_H
...
typedef struct {
    ...
    char     x1008_manufacturerDeviceName[6];
...
#endif /* FRASY_UTILS_COMMUNICATION_CAN_OPEN_OD_H */
