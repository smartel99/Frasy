...
OD_ATTR_PERSIST_COMM OD_PERSIST_COMM_t OD_PERSIST_COMM = {
    ...
    .x1008_manufacturerDeviceName = {'F', 'r', 'a', 's', 'y', 0},
    .x1009_manufacturerHardwareVersion = {'1', '.', '0', '.', '0', 0},
    .x100A_manufacturerSoftwareVersion = {'3', '.', '0', '.', '1', 0},
    ...
    .x1016_consumerHeartbeatTime = {0x00020064, 0x00030064, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000},
