...
#ifndef FRASY_SRC_UTILS_RESULT_ANALYZER_EXPECTATIONS_TO_BE_GREATER_H
...
struct ToBeGreaterExpectation : public ToBeValueBase {
     ...
     * same thing lmao.
     */
    ToBeGreaterExpectation(float min) : ToBeValueBase(min, min, min) {}
    ~ToBeGreaterExpectation() override = default;

    void Render() override
    {
        ImGui::BulletText("Expected: To Be Greater.");
...
#endif    // FRASY_SRC_UTILS_RESULT_ANALYZER_EXPECTATIONS_TO_BE_GREATER_H
